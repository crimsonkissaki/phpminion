...
class AnalyzerFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getAnalyzerDataProvider()
    {
        ...
        return array(
            ...
            array( $path.'ScalarAnalyzer', true ),
            array( $path.'ScalarAnalyzer', false ),
            array( $path.'ScalarAnalyzer', null ),
            array( $path.'ScalarAnalyzer', 10 ),
            array( $path.'ScalarAnalyzer', 3.14 ),
            array( $path.'ScalarAnalyzer', 'string var' ),
